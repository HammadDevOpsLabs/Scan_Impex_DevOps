                            ...
                            <div class="p-3 p-lg-5 border bg-white">
                                ...
                                <form method="post" action="{{route('place-order')}}">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="payment-type" value="cash-on-delivery" id="cash on delivery">
                                        <label class="form-check-label" for="cash on delivery">
                                            cash on delivery
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="payment-type" value="paypal" id="paypal" checked>
